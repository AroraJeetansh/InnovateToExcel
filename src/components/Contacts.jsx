...
const Roadmap = () => {
  const originalContacts = contacts.filter(c => c.id <= 7);
  const newContacts = contacts.filter(c => c.id > 7);
  ...
  return (
    <Section className="overflow-hidden" id="roadmap">
      <div className="container md:pb-8 mt-6">
        ...
        <div className="w-full h-px bg-gradient-to-r from-transparent via-n-4 to-transparent max-w-md mx-auto my-16"></div>
